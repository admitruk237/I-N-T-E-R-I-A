 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        window.addEventListener("DOMContentLoaded", (function() {
            let contentBlock = document.querySelector(".desing__content");
            let bulletBlock = document.querySelector(".bullet-desing__bullet");
            let ElementWidth = document.documentElement.clientWidth;
            if (contentBlock.getBoundingClientRect().left < ElementWidth) contentBlock.classList.add("show");
            setTimeout((function() {
                if (bulletBlock.getBoundingClientRect().left < ElementWidth) bulletBlock.classList.add("show");
            }), 500);
        }));
        window["FLS"] = true;
        isWebp();
